...
namespace Jiannei\Response\Laravel\Support\Facades {
    ...
    class Response {
         ...
         * @static
         */
        public static function ok($message = '', $code = 200)
        {
            /** @var \Jiannei\Response\Laravel\Response $instance */
            return $instance->ok($message, $code);
        }
         ...
         * @static
         */
        public static function localize($code = 200)
        {
            /** @var \Jiannei\Response\Laravel\Response $instance */
            return $instance->localize($code);
        }
         ...
         * @static
         */
        public static function fail($message = '', $code = 500, $errors = null)
        {
            /** @var \Jiannei\Response\Laravel\Response $instance */
            return $instance->fail($message, $code, $errors);
        }
        ...
        {
            /** @var \Jiannei\Response\Laravel\Response $instance */
            return $instance->success($data, $message, $code);
        }
